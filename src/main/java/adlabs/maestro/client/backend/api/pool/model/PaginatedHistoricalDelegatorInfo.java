...
public class PaginatedHistoricalDelegatorInfo {
  ...
  /**
   * Creates a new PaginatedHistoricalDelegatorInfo instance.
   */
  public PaginatedHistoricalDelegatorInfo() {
  }

  /**
   * Creates a new PaginatedHistoricalDelegatorInfo instance with all fields.
   *
   ...
   */
  public PaginatedHistoricalDelegatorInfo(List<HistoricalDelegatorInfo> data, LastUpdated lastUpdated, String nextCursor) {
    this.data = data;
   ...
   * @return the data
   */
  public List<HistoricalDelegatorInfo> getData() {
    return data;
  }
   ...
   * @param data the data
   */
  public void setData(List<HistoricalDelegatorInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Returns a string representation of this PaginatedHistoricalDelegatorInfo.
   *
   * @return a string representation of this object
   */
  @Override
  public String toString() {
    return "PaginatedHistoricalDelegatorInfo{" +
        "data=" + data +
  ...
  public boolean equals(Object o) {
    ...
    PaginatedHistoricalDelegatorInfo that = (PaginatedHistoricalDelegatorInfo) o;
