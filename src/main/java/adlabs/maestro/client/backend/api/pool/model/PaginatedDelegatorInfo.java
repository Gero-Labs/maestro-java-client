...
public class PaginatedDelegatorInfo {
  ...
  /**
   * Creates a new PaginatedDelegatorInfo instance.
   */
  public PaginatedDelegatorInfo() {
  }

  /**
   * Creates a new PaginatedDelegatorInfo instance with all fields.
   *
   ...
   */
  public PaginatedDelegatorInfo(List<DelegatorInfo> data, LastUpdated lastUpdated, String nextCursor) {
    this.data = data;
   ...
   * @return the data
   */
  public List<DelegatorInfo> getData() {
    return data;
  }
   ...
   * @param data the data
   */
  public void setData(List<DelegatorInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Returns a string representation of this PaginatedDelegatorInfo.
   *
   * @return a string representation of this object
   */
  @Override
  public String toString() {
    return "PaginatedDelegatorInfo{" +
        "data=" + data +
  ...
  public boolean equals(Object o) {
    ...
    PaginatedDelegatorInfo that = (PaginatedDelegatorInfo) o;
