...
public class PaginatedTimestampedTransaction {
   ...
   * Default constructor
   */
  public PaginatedTimestampedTransaction() {
  }
   ...
   */
  public PaginatedTimestampedTransaction(List<TimestampedTransaction> data, LastUpdated lastUpdated, String nextCursor) {
    this.data = data;
   ...
   */
  public List<TimestampedTransaction> getData() {
    return data;
  }
   ...
   * @param data the endpoint response data
   */
  public void setData(List<TimestampedTransaction> data) {
    this.data = data;
  }
  ...
  public String toString() {
    return "PaginatedTimestampedTransaction{" +
        "data=" + data +
  ...
  public boolean equals(Object o) {
    ...
    PaginatedTimestampedTransaction that = (PaginatedTimestampedTransaction) o;
