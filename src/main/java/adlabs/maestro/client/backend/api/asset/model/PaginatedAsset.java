...
/**
 * A paginated response for assets. Pass in the `next_cursor` in a subsequent request as the `cursor` query parameter to fetch the next page of results.
 */
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public class PaginatedAsset {
   ...
   */
  public PaginatedAsset(List<Asset> data, LastUpdated lastUpdated, String nextCursor) {
    this.data = data;
  ...
  public boolean equals(Object o) {
    ...
    PaginatedAsset that = (PaginatedAsset) o;
