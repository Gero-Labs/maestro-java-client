...
/**
 * A paginated response for asset holders. Pass in the `next_cursor` in a subsequent request as the `cursor` query parameter to fetch the next page of results.
 */
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public class PaginatedAssetHolder {
  ...
  @NotNull
  @Valid
  private List<@Valid AssetHolder> data;
   ...
   */
  public PaginatedAssetHolder(List<AssetHolder> data, LastUpdated lastUpdated, String nextCursor) {
    this.data = data;
   ...
   */
  public List<AssetHolder> getData() {
    return data;
  }
   ...
   * @param data the endpoint response data
   */
  public void setData(List<AssetHolder> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaginatedAssetHolder that = (PaginatedAssetHolder) o;
