...
/**
 * A paginated response for asset transactions. Pass in the `next_cursor` in a subsequent request as the `cursor` query parameter to fetch the next page of results.
 */
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public class PaginatedAssetTx {
  ...
  @NotNull
  @Valid
  private List<@Valid AssetTx> data;
   ...
   */
  public PaginatedAssetTx(List<AssetTx> data, LastUpdated lastUpdated, String nextCursor) {
    this.data = data;
   ...
   * @param data the endpoint response data
   */
  public void setData(List<AssetTx> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaginatedAssetTx that = (PaginatedAssetTx) o;
