...
/**
 * A paginated response for asset UTXOs. Pass in the `next_cursor` in a subsequent request as the `cursor` query parameter to fetch the next page of results.
 */
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public class PaginatedAssetUtxo {
  ...
  @NotNull
  @Valid
  private List<@Valid AssetUtxo> data;
   ...
   */
  public PaginatedAssetUtxo(List<AssetUtxo> data, LastUpdated lastUpdated, String nextCursor) {
    this.data = data;
   ...
   * @param data the endpoint response data
   */
  public void setData(List<AssetUtxo> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaginatedAssetUtxo that = (PaginatedAssetUtxo) o;
