...
/**
 * A paginated response for mint transactions. Pass in the `next_cursor` in a subsequent request as the `cursor` query parameter to fetch the next page of results.
 */
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public class PaginatedMintTransaction {
  ...
  @NotNull
  @Valid
  private List<@Valid MintTransaction> data;
   ...
   * Default constructor
   */
  public PaginatedMintTransaction() {
  }
   ...
   */
  public PaginatedMintTransaction(List<MintTransaction> data, LastUpdated lastUpdated, String nextCursor) {
    this.data = data;
   ...
   */
  public List<MintTransaction> getData() {
    return data;
  }
   ...
   * @param data the endpoint response data
   */
  public void setData(List<MintTransaction> data) {
    this.data = data;
  }
  ...
  public String toString() {
    return "PaginatedMintTransaction{" +
        "data=" + data +
  ...
  public boolean equals(Object o) {
    ...
    PaginatedMintTransaction that = (PaginatedMintTransaction) o;
