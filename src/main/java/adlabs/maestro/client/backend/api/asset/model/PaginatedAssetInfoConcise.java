...
/**
 * A paginated response for concise asset information. Pass in the `next_cursor` in a subsequent request as the `cursor` query parameter to fetch the next page of results.
 */
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public class PaginatedAssetInfoConcise {
  ...
  @NotNull
  @Valid
  private List<@Valid AssetInfoConcise> data;
   ...
   * Default constructor
   */
  public PaginatedAssetInfoConcise() {
  }
   ...
   */
  public PaginatedAssetInfoConcise(List<AssetInfoConcise> data, LastUpdated lastUpdated, String nextCursor) {
    this.data = data;
   ...
   */
  public List<AssetInfoConcise> getData() {
    return data;
  }
   ...
   * @param data the endpoint response data
   */
  public void setData(List<AssetInfoConcise> data) {
    this.data = data;
  }
  ...
  public String toString() {
    return "PaginatedAssetInfoConcise{" +
        "data=" + data +
  ...
  public boolean equals(Object o) {
    ...
    PaginatedAssetInfoConcise that = (PaginatedAssetInfoConcise) o;
